...
import { Filter, Search, Download, Plus, TrendingUp, TrendingDown } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-card rounded-2xl p-6 shadow-sm border border-border">
          ...
          <h3 className="text-2xl font-semibold text-foreground">$1,200.00</h3>
          <p className="text-xs text-muted-foreground mt-2">Monthly Rent</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#059669] to-[#10b981] rounded-2xl p-6 shadow-lg text-white">
          ...
          <h3 className="text-2xl font-semibold">{expenses.length}</h3>
      ...
      <div className="bg-card rounded-2xl p-6 shadow-sm border border-border">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="font-semibold text-foreground mb-1">All Expenses</h3>
            <p className="text-sm text-muted-foreground">Complete list of your transactions</p>
          </div>
          ...
          <table className="w-full">
            ...
            <tbody>
              {expenses.map((expense) => (
                <tr key={expense.id} className="border-b border-border hover:bg-muted/50 transition-colors duration-200">
